...
|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|
| Mix Bus Glue | `v72` | 0.90 | `off` | 0.00 | 1.00 | -4.1 | +5.3 | 9.4 dB | -6.1 dB | -6.3 dB | OK |
| Mix Bus Glue+ | `v72` | 1.15 | `opto` | 0.28 | 0.55 | -3.9 | +9.1 | 13.0 dB | -6.7 dB | -10.1 dB | OK |
| Master Tone Subtle | `v72` | 0.95 | `tape` | 0.22 | 0.40 | -8.3 | +10.1 | 18.4 dB | -20.6 dB | -11.1 dB | OK |
...
|---|---|---:|---:|---:|---:|---:|---:|
| Mix Bus Glue | `v72` | 0% | -4.1 | +5.3 | 9.4 dB | -6.1 dB | -54.2 |
| Mix Bus Glue | `v72` | 35% | -4.5 | +4.9 | 9.4 dB | -6.5 dB | -54.7 |
| Mix Bus Glue | `v72` | 100% | -5.1 | +4.4 | 9.5 dB | -9.9 dB | -55.9 |
| Mix Bus Glue+ | `v72` | 0% | -3.9 | +9.1 | 13.0 dB | -6.7 dB | -51.8 |
| Mix Bus Glue+ | `v72` | 35% | -4.3 | +8.8 | 13.1 dB | -6.5 dB | -52.6 |
| Mix Bus Glue+ | `v72` | 100% | -5.0 | +8.2 | 13.2 dB | -7.9 dB | -54.1 |
| Master Tone Subtle | `v72` | 0% | -8.3 | +10.1 | 18.4 dB | -20.6 dB | -54.9 |
| Master Tone Subtle | `v72` | 35% | -8.6 | +10.3 | 18.8 dB | -20.6 dB | -55.5 |
| Master Tone Subtle | `v72` | 100% | -9.1 | +10.3 | 19.4 dB | -21.0 dB | -56.7 |
...
| Drum Bus Punch | `marshall` | 100% | +9.8 | +20.6 | 10.8 dB | -27.5 dB | -40.3 |
| Vocal Color (Creative) | `cv` | 0% | -13.5 | -4.3 | 9.3 dB | -12.3 dB | -65.2 |
| Vocal Color (Creative) | `cv` | 35% | -13.7 | -4.6 | 9.1 dB | -12.4 dB | -66.1 |
| Vocal Color (Creative) | `cv` | 100% | -13.8 | -4.6 | 9.2 dB | -12.6 dB | -67.4 |
...
| Vocal Color (Creative) | `cv` | 0.83 | 0.37 | 0.17 | PASS |
| Bass DI Color | `rndi` | 0.85 | 0.34 | 0.09 | PASS |
| Vocal Consonant Recovery | `cv` | 1.00 | 0.32 | 0.19 | PASS |
| Bass Pluck Memory | `rndi` | 0.63 | 0.90 | 0.09 | PASS |
| Drum Transient Iron | `marshall` | 0.91 | 0.40 | 0.14 | PASS |

| Scenario | Preset | Legacy RMS | Fitted RMS | Legacy TP | Fitted TP | Legacy H2-H3 | Fitted H2-H3 | Fitted-Legacy Residual |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| Mix Bus Glue | `v72` | -4.5 | -4.5 | +4.9 | +4.9 | +28.4 dB | +28.3 dB | -63.3 dBFS |
| Mix Bus Glue+ | `v72` | -4.3 | -4.3 | +8.8 | +8.8 | +27.6 dB | +27.6 dB | -58.3 dBFS |
| Master Tone Subtle | `v72` | -8.6 | -8.6 | +10.3 | +10.3 | -8.2 dB | -8.2 dB | -64.5 dBFS |
...
| Vocal Color (Creative) | `cv` | -13.7 | -13.7 | -4.6 | -4.6 | -6.0 dB | -5.9 dB | -64.4 dBFS |
...
- **Mix Bus Glue**: preset `v72`, drive `0.90`, engine `off` (amt `0.00`, mix `1.00`), then set plugin Output trim about `-6.3 dB` to aim around -1 dBTP.
